...
<?php
	...
	if(isset($_POST['submit'])){
		...
		echo "<center>Price : ".$row['price']."</center></td>";
...
?>
                    <td align="center">
						<form method="post" action="Cart.php">
							<input type="submit"style="background-color:Green;"name="submit"value="Add To Cart">
						...
						<form method="post" action="Userpage.php">
							<input type="submit"style="background-color:Red;"name="delete"value="Back To Home">
						</form>
